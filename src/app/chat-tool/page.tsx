...
export default function Chat() {
  ...
  return (
    /* Khung ngoài chiếm trọn 100% chiều cao động của màn hình */
    <div className="relative flex flex-col h-dscreen w-full max-w-4xl mx-auto bg-slate-50 font-sans shadow-2xl border-x border-slate-200/50 overflow-hidden">
      ...
      {/* Messages - pb-32 hoặc pb-40 để tạo khoảng trống dưới đáy, không bị ô Input che mất tin nhắn */}
      <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 scrollbar-thin pb-32 md:pb-40">
      ...
      {/* CỤM ĐÁY: KHÓA CHẶT Ở ĐÁY KHUNG CONTAINS BẰNG ABSOLUTE */}
      <div className="absolute bottom-0 left-0 right-0 w-full bg-gradient-to-t from-slate-50 via-slate-50/95 to-transparent pt-6 pb-safe z-10">
        {error && (
