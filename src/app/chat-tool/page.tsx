...
export default function Chat() {
  ...
  return (
    /* CỐ ĐỊNH KHUNG TOÀN MÀN HÌNH CHỐNG CO RÚT */
    <div className="flex flex-col h-dscreen w-full max-w-4xl mx-auto bg-slate-50 font-sans shadow-2xl border-x border-slate-200/50 overflow-hidden justify-between">
      
      {/* Header - Ghim cố định trên đỉnh */}
      <div className="backdrop-blur-md bg-white/80 border-b border-slate-100 px-6 py-4 flex items-center justify-between shadow-xs shrink-0">
      ...
      {/* Messages - Vùng này tự động giãn rộng để đẩy Input xuống đáy */}
      <div className="grow overflow-y-auto p-4 md:p-6 space-y-6 scrollbar-thin flex flex-col">
      ...
      {/* Error & Input - Luôn bị khóa chặt ở đáy màn hình di động */}
      <div className="shrink-0 bg-gradient-to-t from-slate-50 via-slate-50 to-transparent pb-safe">
        {error && (
